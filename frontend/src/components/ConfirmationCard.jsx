...
const ROUTE_META = {
  staff_deployment: {
    ...
    color: 'text-ihc-blue-600 bg-ihc-blue-50 border-ihc-blue-200',
  },
  mail: {
    ...
    color: 'text-ihc-teal-600 bg-ihc-teal-50 border-ihc-teal-300',
  },
  pickup: {
    label: 'Self-Pickup',
    icon: (
    ...
    color: 'text-ihc-amber-700 bg-ihc-amber-100 border-ihc-amber-300',
  },
};

/** Confidence display mapping */
const CONFIDENCE_MAP = {
  high: { label: 'High', pct: 92, color: 'text-ihc-green-500' },
  medium: { label: 'Medium', pct: 65, color: 'text-ihc-amber-600' },
  low: { label: 'Low', pct: 35, color: 'text-red-500' },
};

/** Chip color classes for AI tags */
const TAG_COLORS = [
  'bg-ihc-blue-100 text-ihc-blue-700',
  'bg-ihc-teal-100 text-ihc-teal-700',
  'bg-ihc-amber-100 text-ihc-amber-700',
...
export default function ConfirmationCard({ result, onSubmitAnother }) {
  ...
  return (
    <Card className="max-w-2xl mx-auto overflow-hidden">
      {/* Success header */}
      <div className="bg-ihc-teal-500 px-6 py-5 text-white">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-ihc-teal-100 text-sm mt-0.5">
      ...
      <div className="px-6 py-5 space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold text-ihc-blue-600 font-mono mt-0.5">{result.id}</p>
          </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-gray-100 rounded-full h-2" role="progressbar" aria-valuenow={confidence.pct} aria-valuemin={0} aria-valuemax={100} aria-label={`AI confidence: ${confidence.pct}%`}>
                    <div
                      className="h-2 rounded-full bg-ihc-teal-500 transition-all duration-500"
        ...
        {result.routingReason && (
          <div>
            <button
              ...
              className="flex items-center gap-2 text-sm font-medium text-ihc-blue-600 hover:text-ihc-blue-800 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ihc-blue-500 rounded"
            ...
            {reasoningOpen && (
              <blockquote className="mt-2 pl-4 border-l-4 border-ihc-teal-500 text-sm text-gray-600 italic">
                {result.routingReason}
              </blockquote>
            )}
          </div>
        ...
        <div className="pt-2 border-t border-gray-100">
          <button
            ...
            className="text-sm font-medium text-ihc-blue-600 hover:text-ihc-blue-800 underline underline-offset-2 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ihc-blue-500 rounded"
          >
