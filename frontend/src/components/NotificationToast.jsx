...
const TOAST_CONFIG = {
  success: {
    bg: 'bg-white border-l-4 border-brand-purple-500',
    icon: (
      <svg className="w-5 h-5 text-brand-purple-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
  ...
  warning: {
    bg: 'bg-white border-l-4 border-brand-yellow-500',
    icon: (
      <svg className="w-5 h-5 text-brand-yellow-500" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
  ...
  info: {
    bg: 'bg-white border-l-4 border-brand-periwinkle-400',
    icon: (
      <svg className="w-5 h-5 text-brand-periwinkle-400" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="shrink-0 text-gray-400 hover:text-gray-600 transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-purple-500 rounded"
