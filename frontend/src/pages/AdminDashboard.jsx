  ...
  return (
    <div className="h-[calc(100vh-64px-52px)] flex flex-col">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="text-xs text-ihc-blue-600 hover:text-ihc-blue-800 font-medium underline underline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ihc-blue-500 rounded"
            >
              Analytics
            </a>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-20 w-12 h-12 rounded-full bg-ihc-blue-500 text-white shadow-lg hover:bg-ihc-blue-600 hover:shadow-xl transition-all duration-200 flex items-center justify-center focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ihc-blue-500"
...
function EmptyDetailState() {
  return (
    <div className="h-full flex flex-col items-center justify-center text-center px-8">
      <div className="w-16 h-16 rounded-2xl bg-ihc-blue-50 border border-ihc-blue-100 flex items-center justify-center mb-4" aria-hidden="true">
        <svg className="w-8 h-8 text-ihc-blue-300" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
